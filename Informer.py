...
probs = np.load('./results/Informer/Informer_probs.npy')  # shape (873,)
...
plt.title("Informer Anomaly Detection on Price Data")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig(os.path.join(save_dir, "informer_price_with_anomalies.png"))
plt.close()
